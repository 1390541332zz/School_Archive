...
\usepackage[size=custom,width=121.92,height=91.44,scale=1.4,orientation=portrait]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
