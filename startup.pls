(begin 
    (define make-point (lambda (x y)  (set-property "object-name" "point" (set-property "size" 0.0001 (list x y))) ))
    ...
    (define continuous-plot (lambda (FUNC BOUNDS OPTIONS) (list FUNC BOUNDS OPTIONS)))
)
